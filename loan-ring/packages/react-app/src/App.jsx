...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "LoanRingContract", "purpose");

  // 📟 Listen for broadcast events
  const setPurposeEvents = useEventListener(readContracts, "LoanRingContract", "SetPurpose", localProvider, 1);
  ...
  */
  ...
  let faucetHint = "";
  const faucetAvailable = false; // localProvider && localProvider.connection && targetNetwork.name.indexOf("local") !== -1;

...
const main = async () => {
  ...
  const LoanRingContract = await deploy("LoanRingContract"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  const LoanRingContract = await deploy("LoanRingContract", [], {
  ...
  */
  ...
  await tenderlyVerify(
    {contractName: "LoanRingContract",
     contractAddress: LoanRingContract.address
  })
  */
